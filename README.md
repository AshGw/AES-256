...
I firmly believe in the power of **Freedom** in a world dominated by control, surveillance, and constant privacy violations , this led me to develop a way to work with a set of tools in Python , levereging the AES-256 algorithm  to make it easier for individuals to safeguard their data without blindly relying on third parties to do it for them , while at the same time making it easy enough for anyone to use even with limited programming knowledge.
